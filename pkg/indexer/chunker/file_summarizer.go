...
func (fs *FileSummarizer) GenerateSummary(content, language string, chunker *Chunker) (string, error) {
	// Go言語の場合はAST解析
	if language == "go" {
...
func (fs *FileSummarizer) generateGoSummary(content string, chunker *Chunker) (string, error) {
...
func (fs *FileSummarizer) generateSimpleSummary(content, language string, chunker *Chunker) (string, error) {
	summary := FileSummary{
		Language:       language,
		MainComponents: []ComponentInfo{},
		Dependencies:   []string{},
...
func (fs *FileSummarizer) buildSummaryText(summary FileSummary, chunker *Chunker) (string, error) {
