...
func buildDirectorySummaryPrompt(directory *types.DirectoryInfo, filesContent, subdirContent string) string {
	// 言語リストの構築
...
func buildArchitectureSummaryPrompt(structure *types.RepoStructure, directorySummariesContent, summaryType string) string {
	var builder strings.Builder
