...
import (
	...
	"github.com/jinford/dev-rag/internal/module/indexing/adapter/dependency"
...
func TestCalculator_CalculateAll(t *testing.T) {
	...
	calculator := NewCalculator(graph, editHistory, nil)
...
func TestCalculator_CustomWeights(t *testing.T) {
	...
	calculator := NewCalculator(graph, editHistory, &customWeights)
...
func TestCalculator_EmptyGraph(t *testing.T) {
	ctx := context.Background()
