...
`
	...
	assert.Contains(t, mainFuncChunk.Metadata.ExternalImports, "github.com/jinford/dev-rag/internal/module/indexing/domain")
}
...
func TestIsStandardLibrary(t *testing.T) {
	...
	assert.False(t, astChunker.isStandardLibrary("github.com/jinford/dev-rag/internal/module/indexing/domain"))
