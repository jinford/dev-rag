...
func (i *Indexer) GetChunk(ctx context.Context, id uuid.UUID) (*domain.Chunk, error) {
...
`
	...
	goModData := map[string]string{
		...
		"github.com/jinford/dev-rag/internal/module/indexing/domain": "v0.1.0",
	...
	t.Run("Imports", func(t *testing.T) {
		...
		// 内部パッケージ
		assert.Equal(t, ImportTypeInternal, info.Imports["github.com/jinford/dev-rag/internal/module/indexing/domain"].Type)
