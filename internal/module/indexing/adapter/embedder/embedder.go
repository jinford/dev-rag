...
func NewEmbedder(apiKey, model string, dimension int) domain.Embedder {
	return &embedder{
...
func (e *embedder) GetMetadata() (*domain.EmbedderMetadata, error) {
	return &domain.EmbedderMetadata{
		ModelName: e.model,
