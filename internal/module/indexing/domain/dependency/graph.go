...
// GetNodeFilePath はチャンクIDからファイルパスを取得します
func (g *Graph) GetNodeFilePath(chunkID uuid.UUID) (string, bool) {
...
// GetAllChunkIDs はグラフ内のすべてのチャンクIDを取得します
func (g *Graph) GetAllChunkIDs() []uuid.UUID {
